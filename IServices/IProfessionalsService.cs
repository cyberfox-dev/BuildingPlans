...
namespace WayleaveManagementSystem.IServices
{
    public interface IProfessionalsService
    {
        ...
        Task<Professionals> AddUpdateProfessional(int? professinalID, string professinalType, string fullName, string bp_Number, bool? bpVerified, string email, string phoneNumber, string professionalRegNo, string appUserID, string IdNumber, string createdById);
